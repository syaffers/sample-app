...
describe User do
  ...
  describe "when password is not present" do
    ...
    before do
      @user = User.new( name: "Dude Guy", email: "dude@guy.com", password: " ", password_confirmation: " " )
    end
    it { should_not be_valid }
  ...
  describe "when email format is valid" do
    ...
    it "should be valid" do
      addresses = %w[user@foo.COM A_US-ER@f.b.com frst.lst@goo.jp a+b@baz.cn]
  ...
  describe "micropost associations" do
    ...
    let!(:newer_micropost) do
      FactoryGirl.create(:micropost, user: @user, created_at: 5.hours.ago)
    end
    ...
    it "should destroy all related microposts for a user" do
